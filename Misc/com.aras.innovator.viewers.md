...
# com.aras.innovator.viewers Assessment
...
------ | ------ | ------ | ------ | ------
abbreviation | Measurement Unit |   | String | 
is_default | Measurement Unit |   | Boolean | 
ratio_to_inch | Measurement Unit |   | Float | 
sequence | Measurement Unit |   | Integer | 
unit | Measurement Unit |   | String | 
units | Measurement Unit |   | String | 
viewer | Measurement Unit |   | Item | [Viewer](#viewer)
